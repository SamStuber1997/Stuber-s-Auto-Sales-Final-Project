...
Partial Public Class DealerDataSet
    ...
    Partial Public Class SoldDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddSoldRow(ByVal Year As String, ByVal Make As String, ByVal Model As String, ByVal Trim As String, ByVal Color As String, ByVal Drivetrain As String, ByVal Mileage As String, ByVal SalePrice As Decimal, ByVal Profit As Decimal, ByVal SellDate As String) As SoldRow
            Dim rowSoldRow As SoldRow = CType(Me.NewRow,SoldRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Year, Make, Model, Trim, Color, Drivetrain, Mileage, SalePrice, Profit, SellDate}
    ...
    Partial Public Class SoldRow
        ...
        Public Property SellDate() As String
            Get
                Try 
                    Return CType(Me(Me.tableSold.SellDateColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'SellDate' in table 'Sold' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableSold.SellDateColumn) = value
            End Set
        End Property
        ...
        Public Function IsSellDateNull() As Boolean
            Return Me.IsNull(Me.tableSold.SellDateColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetSellDateNull()
            Me(Me.tableSold.SellDateColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
    ...
    Partial Public Class SoldTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO Sold"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         (SaleID, Year, Make, Model, Trim, Colo"& _ 
                "r, Drivetrain, Mileage, SalePrice, Profit, SellDate)"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"VALUES        (@SaleID,@Ye"& _ 
                "ar,@Make,@Model,@Trim,@Color,@Drivetrain,@Mileage,@SalePrice,@Profit,@SellDate);"& _ 
                "        "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT SaleID, Year, Make, Model, Trim, Color, Drivetrain, Mileage, Sa"& _ 
                "lePrice, Profit, StockNumber FROM Sold WHERE (SaleID = SCOPE_IDENTITY())"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@SellDate", Global.System.Data.SqlDbType.[Variant], 1024, Global.System.Data.ParameterDirection.Input, 0, 0, "SellDate", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._adapter.UpdateCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Overridable Function Insert(ByVal SaleID As Integer, ByVal Year As String, ByVal Make As String, ByVal Model As String, ByVal Trim As String, ByVal Color As String, ByVal Drivetrain As String, ByVal Mileage As String, ByVal SalePrice As Global.System.Nullable(Of Decimal), ByVal Profit As Global.System.Nullable(Of Decimal), ByVal SellDate As Object) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(10).Value = CType(SellDate,Object)
            End If
            Dim previousConnectionState As Global.System.Data.ConnectionState = Me.Adapter.InsertCommand.Connection.State
            If ((Me.Adapter.InsertCommand.Connection.State And Global.System.Data.ConnectionState.Open)  _
                        <> Global.System.Data.ConnectionState.Open) Then
