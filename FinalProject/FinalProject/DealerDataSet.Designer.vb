...
Namespace DealerDataSetTableAdapters
    ...
    Partial Public Class Inventory1TableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM Inventory1"&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (StockNumber = @StockNumber)"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Inventory1] ([Year], [Make], [Model], [Trim], [Color], [Drivet"& _ 
                ...
                "valDate);"&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT StockNumber, Year, Make, Model, Trim, Color, Drivetrain, Mileag"& _ 
                "e, TrueMarketValue, Price, ArrivalDate FROM Inventory1 WHERE (StockNumber = SCOP"& _ 
                "E_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE       Inventory1"&Global.Microsoft.VisualBasic.ChrW(10)&"SET                Year = @Year, Make = @Make, Model = @M"& _ 
                "odel, Trim = @Trim, Color = @Color, Drivetrain = @Drivetrain, Mileage = @Mileage"& _ 
                ", Price = @Price"&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (StockNumber = @StockNumber);        "&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Stock"& _ 
                "Number, Year, Make, Model, Trim, Color, Drivetrain, Mileage, TrueMarketValue, Pr"& _ 
                "ice, ArrivalDate FROM Inventory1 WHERE (StockNumber = @StockNumber)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT        SUM(TrueMarketValue) AS TotalValueOfDealer"&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Inventor"& _ 
                "y1"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(2) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(2).Connection = Me.Connection
            Me._commandCollection(2).CommandText = "UPDATE       Inventory1"&Global.Microsoft.VisualBasic.ChrW(10)&"SET                Price = Price * @Rate"&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (Ar"& _ 
                "rivalDate < @Date)"
    ...
    Partial Public Class SoldTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO Sold"&Global.Microsoft.VisualBasic.ChrW(10)&"                         (SaleID, Year, Make, Model, Trim, Color"& _ 
                ", Drivetrain, Mileage, SalePrice, Profit)"&Global.Microsoft.VisualBasic.ChrW(10)&"VALUES        (@SaleID,@Year,@Make,@Mo"& _ 
                "del,@Trim,@Color,@Drivetrain,@Mileage,@SalePrice,@Profit);      "&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT SaleID, "& _ 
                "Year, Make, Model, Trim, Color, Drivetrain, Mileage, SalePrice, Profit FROM Sold"& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [Sold] SET [Year] = @Year, [Make] = @Make, [Model] = @Model, [Trim] = @Tri"& _ 
                ...
                "S NULL) OR ([Profit] = @Original_Profit)));"&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT SaleID, Year, Make, Model, Tr"& _ 
                "im, Color, Drivetrain, Mileage, SalePrice, Profit FROM Sold WHERE (SaleID = @Sal"& _ 
                "eID)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        SUM(Profit) AS Expr1"&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Sold"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
        End Sub
